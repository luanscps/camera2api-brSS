...
class WebControlServer(
    ...
    private fun serveStatus(): Response {
        ...
        // RTMP: isStreaming via rtmpCamera em vez de RtspServerCamera2
    ...
    private fun buildHtml(): String {
        ...
        sb.append("function applyRtmpUrl(btn){")
        sb.append("var inp=document.getElementById('rtmp-input');")
        sb.append("var url=inp.value.trim();if(!url)return;")
        sb.append("sendControl({rtmpUrl:url},btn,'RTMP atualizado');}")
        ...
        sb.append("var rtmpEl=document.getElementById('info-rtmpurl');if(rtmpEl)rtmpEl.textContent=d.rtmp_url||'-';")
        sb.append("var inp=document.getElementById('rtmp-input');if(inp&&!inp.value&&d.rtmp_url)inp.value=d.rtmp_url;")
